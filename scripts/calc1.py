...
INTEGER, PLUS, SUBTRACTION, MULT, EOF, SPACE = 'INTEGER', 'PLUS', 'SUBTRACTION', 'MULTI', 'EOF', 'SPACE'
    ...
    def expr(self):
        ...
        while run:
            if self.current_token.type == INTEGER:
                num += str(self.current_token.value)
                self.eat(INTEGER)
            ...
            if self.current_token.type == SUBTRACTION:
        ...
        # Verifique a operação e retorne o resultado
        if operation == PLUS:
            result = sum(nums)
